...
BEGIN
    ...
    simplified_buildings AS (
        ...
        FROM get_simplified_buildings_from_task(project_id, task_id, tolerance) gsft
    )
    SELECT
    ...
    FOR current_project_id IN SELECT unnest(project_ids) LOOP
        ...
        LOOP
            ...
            SELECT
                ...
                grsb.task_area,
                grsb.tolerance_used
            FROM get_ratio_simplified_buildings(current_project_id, current_task_id, tolerance) grsb;
        END LOOP;
