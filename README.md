...
**Relevant notebooks:**
* [View `Large_building_intersections.ipynb`](https://github/Robot8A/task-integration/blob/main/Data-Analysis/Large_building_intersections.ipynb)  
* [View `Road_terminations.ipynb`](https://github/Robot8A/task-integration/blob/main/Data-Analysis/Road_terminations.ipynb)
